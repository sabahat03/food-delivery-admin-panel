...
<style type="text/css">
        * {
        ...
        body {
            ...
            background-image: linear-gradient(0deg, #D9AFD9 0%, #f0e65f 100%);
            height: 100vh;
            display: grid;
...
<div class="container-fluid">
        <div class="row" style="padding-top: 1%;">
            ...
            <div class="col-md-4" style="text-align: center; background-color: #ffffff10; border-radius: 20px; padding: 30px;">
                <!-- Hourglass animation -->
                <img src="assets/logout.png" alt="" height="250px"> <br><br>
                <!-- Hourglass animation ends here -->
                <span style="font-size: 18px; font-weight: 100; text-align: center;">Logged Out Security... <br> <br> You Wil Redirected to Home After 5 Second</span>
            </div>
            <div class="col-md-4"></div>
        </div>
    </div>
