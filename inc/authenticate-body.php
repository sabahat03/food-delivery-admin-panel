    ...
    <div class="container-fluid">
        <div class="row" style="padding-top: 1%;">
            ...
            <div class="col-md-4" style="text-align: center; background-color: #ffffff10; border-radius: 20px; padding: 30px;">
                <!-- Hourglass animation -->
                <div class="hourglass" style="margin-left: 173px; margin-bottom: 20px;"></div>
                <!-- Hourglass animation ends here -->
                <span style="font-size: 18px; font-weight: 100; text-align: center;">Authenticating Your Account....</span>
            </div>
            <div class="col-md-4"></div>
        </div>
    </div>
